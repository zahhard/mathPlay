                ...
                if (inputOperator.isNullOrBlank() || !inputOperator.matches(Regex("^[*]|[-]|[+]|[/]|[%]$"))) {
                    ...
                    try {
                        if (binding.startRangeA.text.isNullOrBlank() ||
                            ...
                            Toast.makeText(this, "please fill all the ranges", Toast.LENGTH_SHORT)
                                .show()
                        } else {
                            if (binding.startRangeA.text.toString()
                                    .toInt() < binding.endRangeA.text.toString()
                                    .toInt() && !binding.startRangeA.text.isNullOrBlank() && !binding.endRangeA.text.isNullOrBlank()
                            ) {
                            ...
                            if (binding.startRangeB.text.toString()
                                    .toInt() < binding.endRangeB.text.toString()
                                    .toInt() && !binding.startRangeB.text.isNullOrBlank() && !binding.endRangeB.text.isNullOrBlank()
                            ) {
